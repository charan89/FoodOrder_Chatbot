...
## story_06_location_out_of_scope_affirm  
* greet
  - utter_greet
* ask_restaurant
  - utter_ask_location
...
## story_07_location_out_of_scope_deny
* greet
  - utter_greet
* ask_restaurant
  - utter_ask_location
...
## story_08_location_cuisine_budget_valid_with_email
* greet
  - utter_greet
* ask_restaurant{"location": "Mumbai", "cuisine": "chinese"}
  - action_location_valid
...
## story_09_location_cuisine_budget_valid_no_email
* greet
  - utter_greet
...
* ask_restaurant
    - utter_ask_location
* ask_restaurant{"location":"Delhi NCR"}
...
* greet
    - utter_greet
* ask_restaurant{"location":"Delhi NCR","cuisine":"chinese"}
    - slot{"cuisine":"chinese"}
    - slot{"location":"Delhi NCR"}
    - action_location_valid
    - slot{"location_validity":"valid"}
